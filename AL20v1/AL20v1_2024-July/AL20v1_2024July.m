...
crankOffsets = [33.75,33.5,33.5,33.25,33.25,33.25,33.25,33]; % to set position of r=0 for each wake station (units: number of cranks from probe's starting position)
