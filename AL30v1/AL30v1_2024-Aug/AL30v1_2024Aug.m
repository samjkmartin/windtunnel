...
crankOffsets = [35.5,35.25,34.75,34.75,35,35,35.25,35.25]; % to set position of r=0 for each wake station (units: number of cranks from probe's starting position)
