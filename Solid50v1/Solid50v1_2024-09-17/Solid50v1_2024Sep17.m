...
crankOffsets = [33.25,33.25,33.25,33.25,33.25,33.25,33.25]; % to set position of r=0 for each wake station (units: number of cranks from probe's starting position)
