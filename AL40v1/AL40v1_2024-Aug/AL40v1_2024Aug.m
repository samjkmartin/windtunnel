...
crankOffsets = [34.75, 34.5, 34.5, 33.75, 33.5, 33.75, 33.75]; % to set position of r=0 for each wake station (units: number of cranks from probe's starting position)
