...
crankOffsets = ones(1,4)*35; % to set position of r=0 for each wake station (units: number of cranks from probe's starting position)
...
uAxis = [0.98 1.005]; % U axis values for all velocity profile plots
