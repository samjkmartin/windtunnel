...
crankOffsets = [33.5,32.5,33.5]-0.5; % to set position of r=0 for each wake station (units: number of cranks from probe's starting position)
...
uAxis = [0.65 1]; % U axis values for all velocity profile plots
