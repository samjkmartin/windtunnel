...
This data from 4/12/24 was measured at a nadir of the S/D=0.2 annular wake (directly
downstream of mid-span) for about 20 seconds using the "slow" setting. 
%}
...
subtitle('S/D=0.2 wake nadir, slow transducer, 20 sec of data')
% xlim([1 10])
% ylim([0 .07])