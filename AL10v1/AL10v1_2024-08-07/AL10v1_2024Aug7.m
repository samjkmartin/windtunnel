...
crankOffsets = [32,32,31.75,31.75]; % to set position of r=0 for each wake station (units: number of cranks from probe's starting position)
...
uAxis = [0.8 1]; % U axis values for all velocity profile plots
