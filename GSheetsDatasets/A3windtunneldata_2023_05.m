...
data = readmatrix('Wind tunnel data v2 2022 - 2023-04-17 A3.csv');
% initiate the velocity matrix
velocity = zeros(130,8);
...
rOverD1 = rOverD1(~isnan(V1)); 
V1 = V1(~isnan(V1)); 

%% another station
% cranks2 = ndgrid(0:0.5:60);
V2 = velocity(:,2);
rOverD2 = rOverD2(~isnan(V2)); 
V2 = V2(~isnan(V2)); 
...
V3 = velocity(:,3);
rOverD3 = rOverD3(~isnan(V3)); 
V3 = V3(~isnan(V3)); 

%% another station 4
% cranks4 = ndgrid(0:0.5:60);
V4 = velocity(:,4);
rOverD4 = rOverD4(~isnan(V4)); 
V4 = V4(~isnan(V4)); 
...
V5 = velocity(:,5);
rOverD5 = rOverD5(~isnan(V5)); 
V5 = V5(~isnan(V5)); 

%% another station 6
% cranks6 = ndgrid(0:0.5:60);
V6 = velocity(:,6);
rOverD6 = rOverD6(~isnan(V6)); 
V6 = V6(~isnan(V6)); 

%% another station 7
% cranks7 = ndgrid(0:0.5:60);
V7 = velocity(:,7);
rOverD7 = rOverD7(~isnan(V7)); 
V7 = V7(~isnan(V7)); 

%% another station 8
% cranks8 = ndgrid(0:0.5:60);
V8 = velocity(:,8);
rOverD8 = rOverD8(~isnan(V8)); 
V8 = V8(~isnan(V8)); 
